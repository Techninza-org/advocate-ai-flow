...
We are on a mission to transform legal operations with AI-driven solutions that reduce complexity, increase efficiency, and expand access to justice. Our platform is built for law firms, businesses, and communities—designed to scale globally, yet adapt locally to the needs of each market we serve.            </p>
  ...
  <div className="relative p-6 rounded-2xl text-white overflow-hidden">
    ...
    <div className="absolute inset-0">
      <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1450101499163-c8848c66ca85?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80')] bg-cover bg-center w-full h-full"></div>
  ...
  <div className="relative p-6 rounded-2xl text-white overflow-hidden">
    {/* Background image with overlay */}
    <div className="absolute inset-0">
      <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1620641788421-7a1c342ea42e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80')] bg-cover bg-center w-full h-full"></div>
